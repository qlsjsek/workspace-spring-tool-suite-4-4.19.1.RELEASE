...
public class RequestParamModelAttributeController {
	...
	/*
	@GetMapping("/parameter_guest_write_action")
	public String get_parameter_guest_write_action() {
		return "forward:/WEB-INF/views/guest_write_form.jsp";
	}
	*/
	...
	public String parameter_guest_write_action(
		 ...
		 */
		Guest insertGuest=Guest.builder()
						.guest_name(name)
	...
	public String model_attribute_guest_write_action(@ModelAttribute Guest insertGuest) {
